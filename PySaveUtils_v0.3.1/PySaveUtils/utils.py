...
class PySaveUtils:
    ...
    def random_color_gen():
        ...
        return tuple(secrets.randbits(8) for _ in range(3))

    @staticmethod    
    def hex_color_gen():
        """Генерирует случайный HEX-цвет в виде строки #RRGGBB."""
        return "#" + "".join(secrets.choice("0123456789ABCDEF") for _ in range(6))
    ...
    @staticmethod
    def uuid_gen():
        """Генерирует случайный UUID в виде строки."""
